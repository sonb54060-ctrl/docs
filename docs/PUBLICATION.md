...
Исходники: отдельная ветка [examples/backup-under-test](https://github.com/sonb54060-ctrl/docs/tree/examples/backup-under-test) в авторском репозитории. Для скачивания используйте архив этой ветки, а не основную ветку репозитория документации.
